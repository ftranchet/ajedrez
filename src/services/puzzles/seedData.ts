...
// Lote radar-61d47692ce33: puzzles de Lichess (CC0) y posiciones tranquilas de
...
export const RADAR_DATASET_VERSION = "radar-61d47692ce33";
...
export const seedRadarItems: RadarItem[] = [
  ...
  {
    "id": "enven-02",
    "fen": "rn1qkb1r/ppp2ppp/8/4p3/3P1nb1/5N2/PPP2PPP/RNBQKB1R w KQkq - 0 7",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-03",
    "fen": "rnbqk2r/p4ppp/1p3n2/2bp4/1P6/2N1PN2/P2B1PPP/R2QKB1R b KQkq - 0 10",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-04",
    "fen": "rn2kbnr/pQp2pp1/4q1bp/8/3P4/8/PP1BPPPP/2R1KBNR b Kkq - 0 10",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-05",
    "fen": "rnb1kb1r/pp2pp1p/1q4p1/3pB3/3p4/3B4/PPP1NPPP/R2QK1NR b KQkq - 1 9",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-06",
    "fen": "r2qkb1r/pppbpppp/2n4n/6N1/4p3/1Q6/PPPP1PPP/RNB1KB1R w KQkq - 6 7",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-07",
    "fen": "r1b2rk1/1p1P1pp1/p2b3p/2p5/3P4/qPnB1N2/P1P2PPP/R2Q1RK1 w - - 1 14",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-08",
    "fen": "rn1q1rk1/pp2ppBp/2p3p1/7P/6b1/5N2/PP2nPP1/R1Q1K2R w KQ - 0 14",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-21",
    "fen": "rnb2rk1/pp1p1ppp/1q2pn2/8/4P3/P1N2N2/1PPBKbPP/R2Q1B1R b - - 1 9",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-22",
    "fen": "r1bqkb1r/pp4pp/1n2pn2/2ppNp2/3PPN2/2P5/PP3PPP/R1BQKB1R b KQkq - 0 8",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-23",
    "fen": "rnb2rk1/2pp1pp1/pp2pq1p/3PP3/8/8/PPP1QbPP/RN1K1BNR b - - 0 10",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-24",
    "fen": "r2qk2r/pp1b1ppp/2nb1n2/3p4/3P4/1Q1B1N2/PP3PPP/RNB1K2R w KQkq - 2 10",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-25",
    "fen": "r1b1kb1r/pp1npppp/8/qB1p4/4PQ2/8/PPPN1PPP/R3K1NR w KQkq - 1 10",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-26",
    "fen": "N5qr/pp2bkpp/4bn2/2n5/1P6/2N1P3/P4PPP/R1BQK2R b KQ - 0 12",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-27",
    "fen": "rn1qk2r/p3bppp/5n2/1p1bp1B1/3P4/2N2Q2/PPP1NPPP/R4RK1 w kq - 0 12",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-28",
    "fen": "r2r1bk1/pp3ppp/1q3n2/3p2B1/1n4b1/2N1PN1P/PPQ1BPP1/3R1RK1 w - - 1 15",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-29",
    "fen": "rn2brk1/pp2b1pp/4p3/4B3/n6P/PP2PN2/3N1PP1/3RKB1R b - - 0 19",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-30",
    "fen": "q3r1k1/2pn1p1p/1p1b1np1/3p1p2/2NP4/2P3P1/1P2PPBP/2BQ1RK1 b - - 1 14",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-31",
    "fen": "Nn3b1r/pp2pkpp/2q2p2/1b6/5Q2/8/1PP2PPP/RNB1K2R w KQ - 1 14",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-32",
    "fen": "r2qk1nr/ppp1ppbp/3p2p1/3Pn3/4PPbP/2N5/PPP3P1/R1BQKB1R w KQkq - 1 8",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
  ...
  {
    "id": "enven-33",
    "fen": "r3k2r/1R3ppp/4pn2/p2pN3/bb1P4/4P1B1/q3BPPP/3Q1RK1 w kq - 4 16",
    "tipo": "envenenada",
    "temas": [
      "envenenada",
      "autojuego-verificado"
