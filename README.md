...
## Estado
Fase 0 (Fundaciones) está completa. Fase 1 (Radar + Cola Universal) está completa técnicamente, con un catálogo offline de 116 posiciones y datos adaptativos persistentes; falta su validación de uso real durante siete días antes de declararla cerrada. Fase 2 (Partidas y análisis en dos fases), Fase 3 (Prescriptor + currículo base, incluidos finales teóricos contra Stockfish) y Fase 4 (módulos avanzados: triage de reloj, regla de candidatas, modificador a ciegas, doble solución y cálculo comprometido con Stoyko semanal) tienen su criterio de salida cumplido y verificado end-to-end; algunos entregables quedan pendientes (bots Maia, importación automática de historial y conversión de ventajas, bloqueados por falta de acceso de red en el entorno de desarrollo). Fase 5 está en progreso: ya incluye batería reservada de transferencia, detector de sobreajuste, métricas honestas de adherencia y experimento individual ABAB; queda el recordatorio opcional. Detalle completo, entregable por entregable, en `docs/roadmap.md`.
